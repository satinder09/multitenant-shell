...
import { FilterDropdownMenu } from '@/components/generic-filter/FilterDropdownMenu';
import { ClickableFilterTags } from '@/components/generic-filter/ClickableFilterTags';
import { FilterDialog } from '@/components/generic-filter/FilterDialog';
            ...
            onRemoveFilter={(ruleId) => {
              ...
              const updatedFilter = {
                ...
                rootGroup: {
                  ...
                  rules: complexFilter.rootGroup.rules.filter(r => r.id !== ruleId)
                }
              };
