...
export class TwoFactorMethodRegistryService implements TwoFactorMethodRegistry {
  ...
  private readonly providers = new Map<TwoFactorMethodType, TwoFactorMethodProvider>();
  ...
  getRegistryStats(): {
    ...
    supportedFeatures: Record<TwoFactorMethodType, string[]>;
  } {
    const stats = {
      totalProviders: this.providers.size,
      enabledMethods: this.getAvailableMethods(),
      supportedFeatures: {} as Record<TwoFactorMethodType, string[]>,
    };
   ...
   */
  validateRequiredMethods(requiredMethods: TwoFactorMethodType[]): void {
